...
mysqli_query($link, 'DELETE FROM ' . $prefix_sql . '_cabine WHERE id = "' . $_GET['supprimer'] . '" ');
...
$countx2 =  mysqli_fetch_array(mysqli_query($link, "SELECT * FROM " . $prefix_sql . "_cabine WHERE id = ".$_POST['edit']." ")); 
...
mysqli_query($link, "UPDATE " . $prefix_sql . "_cabine SET
...
$photo = $nom_file;
    ...
    mysqli_query($link, "INSERT INTO " . $prefix_sql . "_cabine VALUES('', 
...
?>
		<div class="row-fluid">
		    <div class="span12">
<form action="<?php echo $config_urladmin; ?>/index.php?page=cabine" method="post" class="form-horizontal" enctype="multipart/form-data">
...
<?php
            ...
            $sql_url = mysqli_fetch_array(mysqli_query($link, "SELECT * FROM " . $prefix_sql . "_cabine WHERE id = '" . $_GET['edit'] . "' "))
?>
...
?>
                <tr>                                                     
                  ...
                  <td class="center"><center>
                  	<a  href="<?php echo $config_urladmin; ?>/index.php?page=cabine&edit=<?php echo $sql_user['id']; ?>" class="btn btn-primary btn-mini"><span class=" icon-edit"></span></a>
                  	<a onclick="return confirm('Voulez vous vraiment supprimer cette cabine : <?php echo stripslashes($sql_user['nom']); ?>')" href="<?php echo $config_urladmin; ?>/index.php?page=cabine&supprimer=<?php echo $sql_user['id']; ?>" class="btn btn-danger btn-mini"><span class=" icon-remove"></span></a></center>
                  </td>
                </tr>
<?php 
}
